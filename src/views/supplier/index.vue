  ...
  <div>
    ...
    >
      ...
      <el-form-item prop="payType">
        <el-input v-model="formInline.payType" placeholder="联系电话" @focus="supplier"></el-input>  
      </el-form-item>
      <!-- 查询 -->
      <el-form-item>
...
<el-dialog :title="id==2?'编辑会员':'新增会员'" :visible.sync="dialogFormVisible" width="500px" >
  <el-form :model="dialogFormParams" :rules="rules" ref="ResetAll1">
    ...
    <el-form-item label="联系人" :label-width="formLabelWidth" prop="birthday">
    ...
    <el-form-item label="联系电话" :label-width="formLabelWidth" prop="phone">
     ...
     <el-form-item label="备注" :label-width="formLabelWidth" prop="address">
...
export default {
  ...
  methods: {
    ...
    async getMemberList() {
      try {
        const { rows, total } = await MemberApi.getMemberList1(
          this.page,
          this.size,
          this.formInline
        );
