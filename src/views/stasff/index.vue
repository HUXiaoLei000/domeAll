  ...
  <div>
    ...
    >
      ...
      <el-form-item prop="name">
        <el-input v-model="formInline.name" placeholder="项目"></el-input>
      </el-form-item>
    ...
    <el-table :data="tableData" height="400" border style="width: 100%">
      ...
      <el-table-column prop="money" label="年龄" width="120">
      </el-table-column>
      <el-table-column prop="phone" label="电话"> </el-table-column>
      <el-table-column prop="integral" label="薪酬" width="80">
      </el-table-column>
      <el-table-column prop="birthday" label="入职时间" width="100">
      </el-table-column>
